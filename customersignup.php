        ...
        <div class="card cascading-right" style="
          ...
          <div class="card-body p-5 shadow-5 text-center">
            ...
            <form role="form" action="customer_registered_success.php" method="POST">
              ...
              <!-- Username input -->
              <div class="form-outline mb-4">
              <input onkeyup="showHint(this.value)" pattern="^[a-z0-9]{4,}$" class="form-control" id="customer_username" type="text" name="customer_username" placeholder="Your Username" required="">
                <label class="form-label" for="form3Example3">Username </label> <br>
                <label class="form-label" for="form3Example3">(Minimum 4 characters, only lowercase letters and numbers can be used) </label>
              </div>
